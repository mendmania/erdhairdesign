...
function summaryCard() {
  const s = service();
  return `<aside class="booking-aside"><div class="studio-photo"><img src="https://images.unsplash.com/photo-1600948836101-f9ffda59d250?auto=format&fit=crop&w=900&q=85" alt="Warm, light-filled salon interior with mirrors and styling chairs"/><span class="photo-label">A GOOD PLACE TO FEEL GOOD</span><div class="photo-caption">Come as you are.<br><em>Leave a little lighter.</em></div></div>
